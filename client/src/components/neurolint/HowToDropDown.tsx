...
export function HowToDropDown() {
  return (
    ...
    >
      <AccordionItem
        value="howto"
        className="border-0 rounded-lg shadow-none bg-[#1a1d27]"
      >
        ...
        <AccordionContent className="bg-[#20212D] rounded-b-lg text-sm xs:text-base text-gray-200 px-4 py-3 border-t border-[#22242B]">
          <ol className="list-decimal pl-5 pr-1 space-y-2">
            <li>
              <b>Choose layers:</b> Pick which rule-based cleanup steps (layers)
              you want. Beginners can just leave the defaults!
            </li>
            <li>
            ...
            <li>
              <b>Let NeuroLint do the work:</b> Advanced pattern matching will
              upgrade, fix, and modernize your code. Review changes below!
            </li>
          </ol>
          <div className="mt-3 p-3 rounded bg-blue-950/70 text-xs text-blue-200 border-l-4 border-blue-600">
            ...
            <ul className="list-disc pl-4 mt-1 space-y-1">
              <li>
                <b>Layers</b> are rule-based transformation steps—hover each for
                a quick explanation!
              </li>
              <li>
                <b>Beginners:</b> Use the default settings for best results.
              </li>
              <li>
                <b>Mobile:</b> All steps are touch and paste-friendly!
              </li>
            </ul>
          </div>
        </AccordionContent>
