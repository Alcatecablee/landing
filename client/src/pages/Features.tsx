    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 px-4 py-6">
        <div className="container mx-auto max-w-6xl">
          {/* Navigation */}
          <div className="flex flex-col sm:flex-row gap-3 justify-between items-center mb-8 animate-slide-in-down">
            <Link
              to="/"
              className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-900/80 rounded-xl text-sm font-medium backdrop-blur-xl border border-zinc-800/50 hover:border-zinc-700 hover:bg-zinc-900 transition-all duration-300 cubic-bezier(0.4, 0, 0.2, 1) hover:scale-105 hover:-translate-y-0.5 touch-manipulation"
            >
            ...
            <Link
              to="/app"
              className="inline-flex items-center px-4 py-2 bg-white text-black font-medium rounded-xl hover:bg-gray-100 active:bg-gray-200 transition-all duration-300 cubic-bezier(0.4, 0, 0.2, 1) text-sm shadow-lg hover:scale-105 hover:-translate-y-0.5 focus:scale-105 focus:outline-none focus:ring-4 focus:ring-white/30 touch-manipulation"
            >
              Try NeuroLint
            </Link>
          </div>
          ...
          <div className="text-center mb-12 md:mb-16">
            <div className="mb-8 animate-fade-in-scale">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-900/50 border border-zinc-800/50 rounded-xl backdrop-blur-sm mb-6 animate-slide-in-up animate-delay-200">
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 tracking-tight text-white animate-slide-in-up animate-delay-300">
                Multi-Layer Code Analysis
              </h1>

              <p className="text-lg md:text-xl text-zinc-400 max-w-4xl mx-auto leading-relaxed px-4 animate-slide-in-up animate-delay-500">
          ...
          <section className="mb-16 md:mb-20">
            <div className="text-center mb-10 md:mb-12">
              ...
              <p className="text-base md:text-lg text-zinc-400 max-w-3xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
              {layerFeatures.map((layer, index) => {
                ...
                return (
                  <Card
                    key={layer.id}
                    className="bg-zinc-900/40 border border-zinc-800/50 rounded-2xl md:rounded-3xl backdrop-blur-sm hover:bg-zinc-900/60 hover:border-zinc-700/70 transition-all duration-300 cubic-bezier(0.4, 0, 0.2, 1) hover:scale-105 hover:-translate-y-1 hover:shadow-xl animate-slide-in-up"
                    style={{
                  ...
                  >
                    <CardContent className="p-6 md:p-8">
                      <div className="flex flex-col sm:flex-row items-start gap-4 md:gap-6">
                        <div
                          className={`p-3 rounded-2xl ${layer.bgColor} flex-shrink-0 self-center sm:self-start`}
                        >
                          <Icon
                            className={`w-6 h-6 md:w-8 md:h-8 ${layer.color}`}
                          />
                        </div>
                        ...
                        <div className="flex-1 w-full">
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-3">
                            <Badge
                              variant="outline"
                              className="text-zinc-400 border-zinc-700 w-fit"
                            >
                              Layer {layer.id}
                            </Badge>
