                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-zinc-400 text-sm">
                          Reads your codebase and applies AST-powered rule-based
                          logic in carefully designed "layers"
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
          ...
          <TabsContent value="live-sessions" className="space-y-6">
            <Card className="bg-zinc-900 border-zinc-800">
              <CardHeader>
                ...
                <CardDescription className="text-zinc-400">
                  Real-time collaborative coding with NeuroLint analysis
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div>
                  ...
                  <p className="text-zinc-400 mb-4">
                    Live Sessions enable real-time collaborative coding where
                    team members can work together on code while NeuroLint
                    provides instant analysis and suggestions.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      ...
                      <p className="text-zinc-400 text-sm">
                        Start a new collaborative session from your team
                        dashboard. Sessions are automatically saved and can be
                        resumed later.
                      </p>
                    </div>
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      ...
                      <p className="text-zinc-400 text-sm">
                        Use the share button to generate a session link. Team
                        members can join instantly and see your code in
                        real-time.
                      </p>
                    </div>
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      ...
                      <p className="text-zinc-400 text-sm">
                        Type code and see changes synchronized instantly. All
                        participants can edit simultaneously.
                      </p>
                    </div>
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      <h4 className="font-medium text-white mb-2">
                        4. NeuroLint Analysis
                      </h4>
                      <p className="text-zinc-400 text-sm">
                        NeuroLint automatically analyzes your code in real-time
                        across all 6 layers, providing instant feedback and
                        suggestions.
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      ...
                      <p className="text-zinc-400 text-sm">
                        Code changes are synchronized instantly across all
                        participants using WebSocket connections.
                      </p>
                    </div>
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      <h4 className="font-medium text-white mb-2">
                      ...
                      <p className="text-zinc-400 text-sm">
                        Sessions are automatically saved locally and on the
                        server. Resume work anytime.
                      </p>
                    </div>
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      <h4 className="font-medium text-white mb-2">
                      ...
                      <p className="text-zinc-400 text-sm">
                        NeuroLint analyzes code as you type, showing results for
                        all 6 analysis layers in real-time.
                      </p>
                    </div>
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      <h4 className="font-medium text-white mb-2">
                      ...
                      <p className="text-zinc-400 text-sm">
                        See who's online and active in the session with live
                ...
                <div>
                  ...
                  <div className="space-y-2 text-zinc-400">
                    <p>
                      <strong>1.</strong> Navigate to your team dashboard
                    </p>
                    <p>
                      <strong>2.</strong> Click "Start Session" to create a new
                      live session
                    </p>
                    <p>
                      <strong>3.</strong> Share the session link with your team
                      members
                    </p>
                    <p>
                      <strong>4.</strong> Start coding together and watch
                      NeuroLint analyze in real-time
                    </p>
                  </div>
                </div>
                  ...
                  <div className="bg-zinc-800 p-4 rounded-lg">
                    <div className="space-y-2">
                      <p className="text-zinc-400">
                        <strong>Max Participants:</strong> Configure up to 50
                        participants per session
                      </p>
                      <p className="text-zinc-400">
                        <strong>Analysis Delay:</strong> Set how quickly
                        NeuroLint analyzes code changes (100ms - 5000ms)
                      </p>
                      <p className="text-zinc-400">
                        <strong>Auto-Save:</strong> Automatically save code
                        changes to the session
                      </p>
                      <p className="text-zinc-400">
                        <strong>Auto-Analysis:</strong> Enable automatic
                        NeuroLint analysis as you type
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      ...
                      <p className="text-zinc-400 text-sm">
                        If real-time sync is unavailable, sessions still work
                        locally. Changes are saved and can be shared when
                    ...
                    <div className="bg-zinc-800 p-4 rounded-lg">
                      ...
                      <p className="text-zinc-400 text-sm">
                        NeuroLint analysis has a 30-second timeout. Large code
                        files may need to be analyzed in smaller chunks.
                      </p>
                    </div>
                  </div>
                </div>
