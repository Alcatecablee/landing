    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-6 py-8 max-w-7xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8 p-4 border border-zinc-800/50 rounded-xl bg-zinc-900/30 backdrop-blur-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              {teams && teams.length > 0 ? (
                <select
                  value={selectedTeamId}
                  onChange={(e) => setSelectedTeamId(e.target.value)}
                  className="bg-zinc-800 text-white px-4 py-2 rounded-lg border border-zinc-600 text-sm min-w-[200px]"
                >
                  {teams.map((team) => (
              ...
              <div className="flex flex-wrap items-center gap-4 text-zinc-400 text-sm">
                ...
                >
                  <div
                    className={`w-2 h-2 rounded-full ${liveMode ? "bg-green-400 animate-pulse" : "bg-zinc-600"}`}
                  />
                  <span>Live Mode {liveMode ? "ON" : "OFF"}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Users className="w-4 h-4" />
                  <span>{teamData?.members.length || 0} members</span>
                </div>
                <div className="flex items-center gap-2">
                  <Activity className="w-4 h-4" />
                  <span>{teamData?.projects.length || 0} projects</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
            ...
            <Card className="bg-zinc-900/50 border-zinc-800/50 backdrop-blur-sm">
              <CardContent className="p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-zinc-400 text-sm">Innovation</p>
                    <p className="text-2xl font-bold text-white">
            ...
            <Card className="bg-zinc-900/50 border-zinc-800/50 backdrop-blur-sm">
              <CardContent className="p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-zinc-400 text-sm">Collaboration</p>
                    <p className="text-2xl font-bold text-white">
            ...
            <Card className="bg-zinc-900/50 border-zinc-800/50 backdrop-blur-sm">
              <CardContent className="p-5">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-zinc-400 text-sm">Bug Rate</p>
                    <p className="text-2xl font-bold text-white">
          ...
          <Tabs defaultValue="live" className="space-y-6">
            <TabsList className="bg-zinc-900/50 border border-zinc-800/50 p-1 backdrop-blur-sm">
              <TabsTrigger
                value="live"
                className="data-[state=active]:bg-white data-[state=active]:text-black text-zinc-400 text-sm px-4 py-2"
              >
