...
export interface UserData {
  ...
  app_metadata?: any; // Include app_metadata for additional data
}
  ...
  return {
    ...
    user: auth.user
      ? {
          ...
          app_metadata: auth.user.app_metadata, // Include full app_metadata
        }
      : null,
    ...
    incrementUsage,
    syncUser,
    refreshUser: auth.updateUser, // Add refreshUser method
  };
}
