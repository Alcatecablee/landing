...
async function exportAnalytics(format: string, outputPath?: string) {
  ...
  try {
    ...
    const response = await fetch(
      `${config.api.url}/api/enterprise/analytics/export`,
      {
        headers: {
...
async function showDashboard() {
  ...
  try {
    const config = await loadConfig();
    const response = await fetch(
      `${config.api.url}/api/enterprise/analytics/dashboard`,
      {
        headers: {
          Authorization: `Bearer ${config.apiKey}`,
          "Content-Type": "application/json",
...
async function showComplianceReport() {
  ...
  try {
    const config = await loadConfig();
    const response = await fetch(
      `${config.api.url}/api/enterprise/analytics/compliance`,
      {
        headers: {
          Authorization: `Bearer ${config.apiKey}`,
          "Content-Type": "application/json",
...
async function showTeamAnalytics() {
  ...
  try {
    const config = await loadConfig();
    const response = await fetch(
      `${config.api.url}/api/enterprise/analytics/teams`,
      {
        headers: {
          Authorization: `Bearer ${config.apiKey}`,
          "Content-Type": "application/json",
