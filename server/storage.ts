...
export class DatabaseStorage implements IStorage {
  ...
  async getTeamActivities(teamId: string, limit: number = 50): Promise<TeamActivity[]> {
    if (db) {
      ...
      return result.sort((a: TeamActivity, b: TeamActivity) => {
        const aTime = a.createdAt ? (typeof a.createdAt === 'number' ? a.createdAt : a.createdAt.getTime()) : 0;
        const bTime = b.createdAt ? (typeof b.createdAt === 'number' ? b.createdAt : b.createdAt.getTime()) : 0;
        return bTime - aTime;
      });
    } else {
      return this.inMemoryActivities
        .filter((a) => a.teamId === teamId)
        .sort((a: TeamActivity, b: TeamActivity) => {
          const aTime = a.createdAt ? (typeof a.createdAt === 'number' ? a.createdAt : a.createdAt.getTime()) : 0;
          const bTime = b.createdAt ? (typeof b.createdAt === 'number' ? b.createdAt : b.createdAt.getTime()) : 0;
          return bTime - aTime;
        })
